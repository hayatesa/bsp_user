...
Source Database       : book_sharing_platform
...
CREATE TABLE `administrator` (
  `a_uuid` varchar(33) NOT NULL COMMENT '管理员唯一标识',
  `a_id` varchar(30) NOT NULL COMMENT '管理员登录账号',
  `a_password` varchar(33) NOT NULL COMMENT '密码',
  `a_name` varchar(100) NOT NULL COMMENT '姓名',
  `a_phone` varchar(20) NOT NULL COMMENT '联系电话',
  `a_address` varchar(255) NOT NULL COMMENT '运营方地址',
  `a_comments` varchar(255) DEFAULT NULL COMMENT '运营者描述',
...
CREATE TABLE `check_demand_book` (
  ...
  `cdb_name` varchar(255) NOT NULL COMMENT '需求图书名称',
  `cdb_author` varchar(100) NOT NULL COMMENT '需求图书作者',
  `cdb_publishing` varchar(100) DEFAULT NULL COMMENT '需求图书出版社',
  `isbn` varchar(30) DEFAULT NULL COMMENT '需求图书的ISBN',
  `cdb_duration` int(11) NOT NULL COMMENT '需求图书需求时长',
  `cdb_number` int(11) NOT NULL COMMENT '需要图书数量',
  `image_path` varchar(255) DEFAULT NULL COMMENT '需求图书照片路径',
  `cdb_comment` varchar(255) DEFAULT NULL COMMENT '备注',
  `phone` varchar(12) NOT NULL COMMENT '需求者联系电话',
  `cdb_status` tinyint(4) NOT NULL COMMENT '图书审核状态:0提交申请未审核转态，1申请失败返回原因',
  `failure_cause` varchar(255) DEFAULT NULL COMMENT '审核人员填写，审核失败的原因',
  `sc_id` int(11) NOT NULL COMMENT '需求图书所属的二级分类',
  `uuid` varchar(33) NOT NULL COMMENT '需求图书申请人',
  PRIMARY KEY (`cdb_id`) USING BTREE,
  KEY `FKc6if89oh86n3vxut5uuave8a8` (`sc_id`) USING BTREE,
  KEY `FKhid2mb9kb9d8a2p0yovaapvfb` (`uuid`) USING BTREE,
  CONSTRAINT `FKc6if89oh86n3vxut5uuave8a8` FOREIGN KEY (`sc_id`) REFERENCES `secondary_classification` (`sc_id`),
  CONSTRAINT `FKhid2mb9kb9d8a2p0yovaapvfb` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of check_demand_book
-- ----------------------------
...
CREATE TABLE `check_loanable_book` (
  ...
  `clb_author` varchar(100) NOT NULL COMMENT '共享图书作者',
  `clb_name` varchar(255) NOT NULL COMMENT '共享图书名称',
  `clb_publishing` varchar(100) DEFAULT NULL COMMENT '共享图书出版社',
  `isbn` varchar(30) NOT NULL COMMENT '共享图书的ISBN',
  `clb_duration` int(11) NOT NULL COMMENT '图书可共享时长',
  `clb_number` int(11) NOT NULL COMMENT '可共享图书数量',
  `image_path` varchar(255) DEFAULT NULL COMMENT '共享图书照片路径',
  `clb_comment` varchar(255) DEFAULT NULL COMMENT '备注',
  `phone` varchar(12) NOT NULL COMMENT '共享者的联系电话',
  `clb_status` tinyint(4) NOT NULL COMMENT '图书审核状态:0提交申请未审核转态，1申请失败返回原因',
  `failure_cause` varchar(255) DEFAULT NULL COMMENT '审核人员填写，审核失败的原因',
  `sc_id` int(11) NOT NULL COMMENT '共享图书所属的二级分类',
  `uuid` varchar(33) NOT NULL COMMENT '共享图书申请人',
  PRIMARY KEY (`clb_id`) USING BTREE,
  KEY `FKkld0wnb45l7fsg94ulvg97jgm` (`sc_id`) USING BTREE,
  KEY `FKqckqc9s430podyftxap7a8skx` (`uuid`) USING BTREE,
  CONSTRAINT `FKkld0wnb45l7fsg94ulvg97jgm` FOREIGN KEY (`sc_id`) REFERENCES `secondary_classification` (`sc_id`),
  CONSTRAINT `FKqckqc9s430podyftxap7a8skx` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `demand_book` (
  ...
  `db_name` varchar(255) NOT NULL COMMENT '需求图书名称',
  `db_author` varchar(100) NOT NULL COMMENT '需求图书作者',
  `db_publishing` varchar(100) DEFAULT NULL COMMENT ' 需求图书的出版社',
  `isbn` varchar(30) DEFAULT NULL COMMENT '需求图书的ISBN',
  `db_duratuin` int(11) NOT NULL COMMENT '需求图书时长',
  `db_number` int(11) NOT NULL COMMENT '需求图书的数量',
  `image_path` varchar(255) DEFAULT NULL COMMENT '需求图书照片路径',
  `db_comment` varchar(255) DEFAULT NULL COMMENT '备注',
  `phone` varchar(12) NOT NULL COMMENT ' 需求者的联系电话',
  ...
  `sc_id` int(11) NOT NULL COMMENT ' 需求图书所属的二级分类',
  `uuid` varchar(33) NOT NULL COMMENT '需求图书所属的用户',
  PRIMARY KEY (`db_id`) USING BTREE,
  KEY `FKm8v0asyr2m1gj705j3au5d6e6` (`sc_id`) USING BTREE,
  KEY `FKpsm7rge07898jwqf63o33t7fg` (`uuid`) USING BTREE,
  CONSTRAINT `FKm8v0asyr2m1gj705j3au5d6e6` FOREIGN KEY (`sc_id`) REFERENCES `secondary_classification` (`sc_id`),
  CONSTRAINT `FKpsm7rge07898jwqf63o33t7fg` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of demand_book
-- ----------------------------
...
CREATE TABLE `donated_book` (
  ...
  `dob_name` varchar(255) NOT NULL COMMENT '捐赠的图书名称',
  `isbn` varchar(30) NOT NULL COMMENT '捐赠的图书ISBN号',
  `number` int(11) NOT NULL COMMENT '捐赠的图书数量',
  `sc_id` int(11) NOT NULL COMMENT '捐赠图书所属的二级分类',
  `uuid` varchar(33) NOT NULL COMMENT '捐赠人',
  PRIMARY KEY (`dob_id`) USING BTREE,
  KEY `FKh45bmrwc34etref3un2f51pj0` (`sc_id`) USING BTREE,
  KEY `FKqk83s5hu3qrgnydw0dboku20e` (`uuid`) USING BTREE,
  CONSTRAINT `FKh45bmrwc34etref3un2f51pj0` FOREIGN KEY (`sc_id`) REFERENCES `secondary_classification` (`sc_id`),
  CONSTRAINT `FKqk83s5hu3qrgnydw0dboku20e` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `lending_history` (
  ...
  `loan_phone` varchar(255) DEFAULT NULL COMMENT '借阅人电话号码',
  `lb_id` int(11) NOT NULL COMMENT '借阅的图书',
  `uuid` varchar(33) NOT NULL COMMENT '借阅人',
  `receive_uuid` varchar(33) DEFAULT NULL COMMENT '收到借出人送达图书的管理员',
  `back_uuid` varchar(33) DEFAULT NULL COMMENT '收到借阅人还图书的管理员',
  PRIMARY KEY (`lh_id`) USING BTREE,
  KEY `FKh4lfbyr8nb9px111xy30sq53a` (`back_uuid`) USING BTREE,
  KEY `FKr8bar09oqoy4qtbhmuajgggfw` (`lb_id`) USING BTREE,
  KEY `FK4mb3dn1kfkapetlj4v9x37krn` (`receive_uuid`) USING BTREE,
  KEY `FKmwnhbcswmtuspk8hyyrakxna4` (`uuid`) USING BTREE,
  CONSTRAINT `FK4mb3dn1kfkapetlj4v9x37krn` FOREIGN KEY (`receive_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FKh4lfbyr8nb9px111xy30sq53a` FOREIGN KEY (`back_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FKmwnhbcswmtuspk8hyyrakxna4` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`),
  CONSTRAINT `FKr8bar09oqoy4qtbhmuajgggfw` FOREIGN KEY (`lb_id`) REFERENCES `loanable_book` (`lb_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of lending_history
-- ----------------------------
...
CREATE TABLE `lending_record` (
  ...
  `loan_phone` varchar(12) DEFAULT NULL COMMENT '借阅人电话号码',
  `lb_id` int(11) NOT NULL COMMENT '借阅的图书',
  `uuid` varchar(33) NOT NULL COMMENT '借阅人',
  `receive_uuid` varchar(33) DEFAULT NULL COMMENT '收到借出人送达图书的管理员',
  `back_uuid` varchar(33) DEFAULT NULL COMMENT '收到借阅人还图书的管理员',
  PRIMARY KEY (`lr_id`) USING BTREE,
  KEY `FK3ihcdi8oemx69a00pcb9fkrpg` (`back_uuid`) USING BTREE,
  KEY `FK25q7i39xrtwj48c2wq6kb4dr6` (`lb_id`) USING BTREE,
  KEY `FKawpqnxsx4w797jlmoykoos37k` (`receive_uuid`) USING BTREE,
  KEY `FK9d77hacy0ngffex45q08qx8j5` (`uuid`) USING BTREE,
  CONSTRAINT `FK25q7i39xrtwj48c2wq6kb4dr6` FOREIGN KEY (`lb_id`) REFERENCES `loanable_book` (`lb_id`),
  CONSTRAINT `FK3ihcdi8oemx69a00pcb9fkrpg` FOREIGN KEY (`back_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FK9d77hacy0ngffex45q08qx8j5` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`),
  CONSTRAINT `FKawpqnxsx4w797jlmoykoos37k` FOREIGN KEY (`receive_uuid`) REFERENCES `administrator` (`a_uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `loanable_book` (
  ...
  `lb_name` varchar(255) NOT NULL COMMENT '共享图书名称',
  `lb_author` varchar(100) NOT NULL COMMENT '共享图书作者',
  `lb_publishing` varchar(100) DEFAULT NULL COMMENT '共享图书出版社',
  `isbn` varchar(30) NOT NULL COMMENT '共享图书的ISBN',
  `lb_duratuin` int(11) NOT NULL COMMENT '共享图书可共享时长',
  `lb_number` int(11) NOT NULL COMMENT '可共享图书数量',
  `image_path` varchar(255) DEFAULT NULL COMMENT '共享图书照片路径',
  `lb_comment` varchar(255) DEFAULT NULL COMMENT '备注',
  `phone` varchar(12) NOT NULL COMMENT '共享者的联系电话',
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '删除图书：0没有删除，1表示删除，默认为0',
  `sc_id` int(11) NOT NULL COMMENT '共享图书所属的二级分类',
  `uuid` varchar(33) NOT NULL COMMENT '共享图书所属的用户',
  PRIMARY KEY (`lb_id`) USING BTREE,
  KEY `FKtdh9wvruiyi1w3t03m4ollqpd` (`sc_id`) USING BTREE,
  KEY `FK1xj6yghopeuuwsp2i6wlilpfg` (`uuid`) USING BTREE,
  CONSTRAINT `FK1xj6yghopeuuwsp2i6wlilpfg` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`),
  CONSTRAINT `FKtdh9wvruiyi1w3t03m4ollqpd` FOREIGN KEY (`sc_id`) REFERENCES `secondary_classification` (`sc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `mapping` (
  `mapkey` varchar(255) NOT NULL COMMENT '主键，键',
  `m_value` longtext COMMENT ' 值',
...
CREATE TABLE `news` (
  ...
  `n_subject` varchar(255) NOT NULL COMMENT '通知消息标题',
  `n_content` longtext NOT NULL COMMENT '通知消息内容',
  `news_time` datetime NOT NULL COMMENT '产生消息的时间',
  `uuid` varchar(33) DEFAULT NULL COMMENT '通知消息所属的用户 ',
  PRIMARY KEY (`n_id`) USING BTREE,
  KEY `FKf96u6pu7bsv28mi8kwql3ubb7` (`uuid`) USING BTREE,
  CONSTRAINT `FKf96u6pu7bsv28mi8kwql3ubb7` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `primary_classification` (
  ...
  `pc_name` varchar(50) DEFAULT NULL COMMENT '一级分类名称',
...
CREATE TABLE `respond_history` (
  ...
  `respond_phone` varchar(12) DEFAULT NULL COMMENT '响应者电话号码',
  `db_id` int(11) NOT NULL COMMENT '需求的图书',
  `uuid` varchar(33) NOT NULL COMMENT '响应者',
  `receive_uuid` varchar(33) DEFAULT NULL COMMENT '收到借出人送到图书的管理员',
  `back_uuid` varchar(33) DEFAULT NULL COMMENT '收到借阅人还图书的管理员',
  PRIMARY KEY (`rh_id`) USING BTREE,
  KEY `FKc4n2o3pnt7v1ro1llit26bdh9` (`back_uuid`) USING BTREE,
  KEY `FKpitdtd9j0unkorryr5v9o6peo` (`db_id`) USING BTREE,
  KEY `FKm3dc3iuwl80ca9gg0nixapqpa` (`receive_uuid`) USING BTREE,
  KEY `FKen5iu87u8vxcd5fiigbd7m2fy` (`uuid`) USING BTREE,
  CONSTRAINT `FKc4n2o3pnt7v1ro1llit26bdh9` FOREIGN KEY (`back_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FKen5iu87u8vxcd5fiigbd7m2fy` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`),
  CONSTRAINT `FKm3dc3iuwl80ca9gg0nixapqpa` FOREIGN KEY (`receive_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FKpitdtd9j0unkorryr5v9o6peo` FOREIGN KEY (`db_id`) REFERENCES `demand_book` (`db_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of respond_history
-- ----------------------------
...
CREATE TABLE `respond_record` (
  ...
  KEY `FK89a26aixakyy0k9o7ikpukkre` (`back_uuid`) USING BTREE,
  KEY `FK1cmp26fjwow0e0srh5q4xkaor` (`db_id`) USING BTREE,
  KEY `FK8qaplwhx6f0yc7qjwtby8d2dr` (`receive_uuid`) USING BTREE,
  KEY `FK5k9cn0i74f6tkxvypn0x6p33a` (`uuid`) USING BTREE,
  CONSTRAINT `FK1cmp26fjwow0e0srh5q4xkaor` FOREIGN KEY (`db_id`) REFERENCES `demand_book` (`db_id`),
  CONSTRAINT `FK5k9cn0i74f6tkxvypn0x6p33a` FOREIGN KEY (`uuid`) REFERENCES `user` (`uuid`),
  CONSTRAINT `FK89a26aixakyy0k9o7ikpukkre` FOREIGN KEY (`back_uuid`) REFERENCES `administrator` (`a_uuid`),
  CONSTRAINT `FK8qaplwhx6f0yc7qjwtby8d2dr` FOREIGN KEY (`receive_uuid`) REFERENCES `administrator` (`a_uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of respond_record
-- ----------------------------
...
CREATE TABLE `secondary_classification` (
  ...
  `sc_name` varchar(50) NOT NULL COMMENT '二级分类名称',
  `pc_id` int(11) NOT NULL COMMENT '所属一级分类',
  `is_delete` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除分类 0表示没有删除，1表示删除，默认为0',
  PRIMARY KEY (`sc_id`) USING BTREE,
  KEY `FKfnox8i80pxh4rxj3ubjk7b0kd` (`pc_id`) USING BTREE,
  CONSTRAINT `FKfnox8i80pxh4rxj3ubjk7b0kd` FOREIGN KEY (`pc_id`) REFERENCES `primary_classification` (`pc_id`)
...
CREATE TABLE `user` (
  `uuid` varchar(33) NOT NULL COMMENT '用户唯一标识符号',
  `mail` varchar(255) NOT NULL COMMENT '用户邮箱，作为用户登录账号',
  `password` varchar(33) NOT NULL COMMENT '用户登录账号密码',
...
CREATE TABLE `user_infor` (
  `uuid` varchar(33) NOT NULL COMMENT '用户唯一标识来源于user表主键',
  `u_nickname` varchar(15) NOT NULL COMMENT '用户的昵称',
  `u_sex` varchar(2) NOT NULL COMMENT '用户性别',
  `u_phone` varchar(12) NOT NULL COMMENT '用户联系手机号码',
  `u_address` varchar(255) DEFAULT NULL COMMENT '用户联系地址',
  `u_qq` varchar(16) DEFAULT NULL COMMENT '用户QQ号',
  `u_wechat` varchar(255) DEFAULT NULL COMMENT '用户微信号',
  `u_headpath` varchar(255) DEFAULT NULL COMMENT '头像路径',
  `u_signature` varchar(255) DEFAULT NULL COMMENT '用户个性签名 ',
  PRIMARY KEY (`uuid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
